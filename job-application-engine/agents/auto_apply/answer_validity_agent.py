...
try:  # Local package import when running inside job-application-engine
    from ..gemini_client import GeminiClient, GeminiConfig
except ImportError:  # Fallback when modules are loaded as top-level packages
    from gemini_client import GeminiClient, GeminiConfig  # type: ignore
